...
class TempRampSerializer(serializers.Serializer):
    ...
    duration = serializers.IntegerField(min_value=0, max_value=360000, default=600)
...
class TempSineSerializer(serializers.Serializer):
    name = serializers.CharField(max_length=32, default="Unnamed")
    frequency = serializers.IntegerField(min_value=0, max_value=360000, default=600)
    amplitude = serializers.FloatField(min_value=0, max_value=50, default=15)
    offset_x = serializers.IntegerField(min_value=0, max_value=360000, default=0)
